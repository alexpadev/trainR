...
const Login = () => {
    ...
    const handleLogin = async (email, password) => {
        ...
        if (!users.some(user => user.password === password)) {
            console.error("Contraseá incorrecta");
            return;
        }
    ...
    return(
        <div className="bg-gray-800 min-h-screen text-white text-center p-10 py-40">
            ...
            <h1 className="text-gray-200 text-2xl font-semibold mb-6">Iniciar sesión</h1>
                ...
                <p className="mt-4 text-gray-400">Todavía no tienes una cuenta? <a href="/register" className="font-semibold text-emerald-400 hover:text-emerald-500 transition">Regístrate aquí</a></p>
